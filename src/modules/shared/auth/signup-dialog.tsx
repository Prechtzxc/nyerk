...
export function SignupDialog({ className, children }: SignupDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={(val) => {
      ...
      <DialogContent className="sm:max-w-[640px] p-0 max-h-[92vh] overflow-hidden flex flex-col">
        <DialogHeader className="border-b border-slate-100 p-6 pb-5">
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6 pt-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="flex justify-center rounded-2xl border border-dashed border-slate-200 bg-gradient-to-b from-slate-50 to-white p-5">
              <ProfilePictureUploader
                ...
                size="lg"
                label={profilePicture ? "Picture ready" : "Add a profile picture (optional)"}
                hint="Optional · JPG, JPEG, PNG, or WEBP · max 2MB"
              />
            </div>
            ...
            <div className="rounded-xl border border-orange-100 bg-orange-50/70 p-3 text-[11px] font-medium leading-5 text-orange-800">
            ...
            <Button
              type="submit"
              className="w-full bg-orange-600 hover:bg-orange-700 text-white h-12 rounded-md font-bold mt-2 shadow-sm"
            ...
            <div className="text-center text-sm text-slate-500 pt-2">
              ...
              <button
                ...
                className="font-bold text-orange-600 hover:underline hover:text-orange-700 transition-colors"
              >
                Login
              </button>
            </div>
