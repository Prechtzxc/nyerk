...
export function VirtualTour({ open, onOpenChange }: VirtualTourProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="max-w-[95vw] md:max-w-[90vw] w-full h-[100dvh] md:h-[90vh] p-0 overflow-hidden border-none bg-black rounded-none md:rounded-[2rem] shadow-2xl z-[99999] [&>button]:hidden">
