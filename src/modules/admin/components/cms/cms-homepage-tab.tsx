    ...
    <div>
      <CMSSectionHeader title="Homepage" description="Edit all landing page content, branding, and footer details."
        ...
        action={<Button type="button" onClick={handleSave}
          className="h-9 rounded-lg bg-orange-600 px-4 text-xs font-bold text-white hover:bg-orange-700">
      ...
      <div className="max-w-4xl space-y-6">
        ...
        <section className="rounded-xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="grid gap-5 p-6">
            <div>
              <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Hero Badge</label>
              <Input value={form.heroBadge || ""} onChange={(e) => setForm({ ...form, heroBadge: e.target.value })}
                className="mt-1.5 h-10 rounded-lg border-slate-200 text-sm font-semibold" placeholder="Event Venue · San Pedro, Laguna" />
            </div>
            <div>
              <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Hero Title</label>
            ...
            <div>
              <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Hero Subtitle</label>
        ...
        <section className="rounded-xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="grid gap-5 p-6">
            <div>
              <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Section Label</label>
              <Input value={form.aboutLabel || ""} onChange={(e) => setForm({ ...form, aboutLabel: e.target.value })}
                className="mt-1.5 h-10 rounded-lg border-slate-200 text-sm font-semibold" placeholder="Our Story" />
            </div>
            <div>
              <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Section Title</label>
              <Input value={form.aboutTitle || ""} onChange={(e) => setForm({ ...form, aboutTitle: e.target.value })}
                className="mt-1.5 h-10 rounded-lg border-slate-200 text-sm font-semibold" placeholder="One Estela Place Event Venue" />
            </div>
            <div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <Input value={form.galleryLabel || ""} onChange={(e) => setForm({ ...form, galleryLabel: e.target.value })}
                    className="mt-1.5 h-10 rounded-lg border-slate-200 text-sm font-semibold" placeholder="Past Client Bookings" />
                </div>
                <div>
                  <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Title</label>
                  <Input value={form.galleryTitle || ""} onChange={(e) => setForm({ ...form, galleryTitle: e.target.value })}
                    className="mt-1.5 h-10 rounded-lg border-slate-200 text-sm font-semibold" placeholder="Real Events Hosted at One Estela Place" />
                </div>
              </div>
              <div>
                <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Subtitle</label>
                <Textarea value={form.gallerySubtitle || ""} onChange={(e) => setForm({ ...form, gallerySubtitle: e.target.value })}
                  className="mt-1.5 min-h-[60px] resize-none rounded-lg border-slate-200 text-sm font-semibold" />
              </div>
            </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <Input value={form.faqLabel || ""} onChange={(e) => setForm({ ...form, faqLabel: e.target.value })}
                    className="mt-1.5 h-10 rounded-lg border-slate-200 text-sm font-semibold" placeholder="Help Center" />
                </div>
                <div>
                  <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Title</label>
                  <Input value={form.faqTitle || ""} onChange={(e) => setForm({ ...form, faqTitle: e.target.value })}
                    className="mt-1.5 h-10 rounded-lg border-slate-200 text-sm font-semibold" placeholder="Frequently Asked Questions" />
                </div>
              </div>
              <div>
                <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Subtitle</label>
          ...
          <div className="grid gap-5 p-6">
            <div>
              ...
              <Input value={form.ctaTitle || ""} onChange={(e) => setForm({ ...form, ctaTitle: e.target.value })}
                className="mt-1.5 h-10 rounded-lg border-slate-200 text-sm font-semibold" placeholder="Ready to plan your next event?" />
            </div>
            <div>
              <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Description</label>
              <Textarea value={form.ctaDescription || ""} onChange={(e) => setForm({ ...form, ctaDescription: e.target.value })}
                className="mt-1.5 min-h-[80px] resize-none rounded-lg border-slate-200 text-sm font-semibold" />
            </div>
          </div>
        </section>
        ...
        <section className="rounded-xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="grid gap-5 p-6">
            <div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Brand Name</label>
                  <Input value={footer.brandName || ""} onChange={(e) => setFooter({ ...footer, brandName: e.target.value })}
                    className="mt-1.5 h-10 rounded-lg border-slate-200 text-sm font-semibold" placeholder="One Estela Place" />
                </div>
                <div>
                  <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Copyright Text</label>
                  <Input value={footer.copyrightText || ""} onChange={(e) => setFooter({ ...footer, copyrightText: e.target.value })}
                    className="mt-1.5 h-10 rounded-lg border-slate-200 text-sm font-semibold" placeholder="One Estela Place. All rights reserved." />
                </div>
              </div>
              <div>
                <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Footer Description</label>
            ...
            <div className="border-t border-slate-200 pt-5">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Email</label>
                  <Input value={footer.email || ""} onChange={(e) => setFooter({ ...footer, email: e.target.value })}
                    className="mt-1.5 h-10 rounded-lg border-slate-200 text-sm font-semibold" />
                </div>
                <div>
                  <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Phone</label>
                  <Input value={footer.phone || ""} onChange={(e) => setFooter({ ...footer, phone: e.target.value })}
                    className="mt-1.5 h-10 rounded-lg border-slate-200 text-sm font-semibold" />
                </div>
                <div>
                  <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Address</label>
            ...
            <div className="border-t border-slate-200 pt-5">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Facebook URL</label>
                  <Input value={footer.facebook || ""} onChange={(e) => setFooter({ ...footer, facebook: e.target.value })}
                    className="mt-1.5 h-10 rounded-lg border-slate-200 text-sm font-semibold" />
                </div>
                <div>
                  <label className="text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">Instagram URL</label>
